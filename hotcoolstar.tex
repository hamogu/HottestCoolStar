...
\author[0000-0001-9834-7579]{Carl Melis}
\affiliation{Center for Astrophysics and Space Sciences, University of California, San Diego, CA 92093-0424, USA}
...
\textbf{\citet{2008ApJ...685..478N} observed O~{\sc vi} in 6 of 8 stars with  $T_\mathrm{eff}>8300$~K, but similar to the X-rays, then present several lines of evidence that the X-ray emission is due to a low-mass companion in all six cases.}
...
\textbf{X-ray and C~{\sc iii} 977~\AA{} fluxes are listed in Table~\ref{tab}, which also includes a comparison fluxes and upper limits to other main-sequence stars from the literature}.
