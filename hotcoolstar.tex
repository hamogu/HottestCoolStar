...
\begin{abstract}
Cool stars on the main sequence generate X-rays from coronal activity, powered by a convective dynamo. With increasing temperature, the convective envelope becomes smaller and X-ray emission fainter. We present Chandra/HRC-I observations of four single stars with early A spectral types. Only the coolest star of this sample, $\tau^3$~Eri ($T_\mathrm{eff}\approx8\,,210$\,K), is detected with $\log(L_X/L_\mathrm{bol})=-7.6$, while the three hotter stars ($T_\mathrm{eff}\geq8\,,300$\,K), namely $\delta$~Leo, $\beta$~Leo, and $\iota$~Cen, remain undetected with upper limits $\log(L_X/L_\mathrm{bol})<-8.4$. The drop in X-ray emission thus occurs a in very narrow range of effective temperatures ($\sim 100$\,K) and matches the end of activity in the \ion{C}{3} and \ion{O}{6} transition region lines.
...
\bestbf{In the sub-sample studied by \citet{2000A&A...359..227H}, X-ray hardness and flux are similar to late-type stars, indicating unresolved companions are responsible for that emission. \citet{2003A&A...407.1067S} observed five targets with \emph{Chandra}. In three targets, the X-rays are due to a resolved companion, and \citet{2003A&A...407.1067S} argue that the remaining targets probably have an unresolved companion that generates the X-ray emission.}
